...
namespace SmartCare.InfraStructure.Repositories
{
    ...
    {
        #region Feild
        private readonly UserManager<ApplictionUser> _PharmacistManager;
        private readonly ApplicationDBContext _context;

        #endregion

        public PharmacistRepository(UserManager<ApplictionUser> pharmacistManager, ApplicationDBContext context) : base(context)
        {
