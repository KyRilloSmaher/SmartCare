...
namespace SmartCare.InfraStructure.Migrations
{
    ...
    [Migration("20260512155429_Delivery-Version")]
    partial class DeliveryVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartCare.Domain.Entities.Contradiction", b =>
                {
                    ...
                    b.HasIndex("Ingredient_B")
                        .HasDatabaseName("IX_Contradictions_Ingredient_B");

                    b.HasIndex("Ingredient_A", "Ingredient_B")
                        .IsUnique()
            ...
            modelBuilder.Entity("SmartCare.Domain.Entities.Delivery", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SmartCare.Domain.Entities.OnlineOrder", b =>
                {
                    ...
                    b.Property<decimal?>("DeleiveryFees")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("SmartCare.Domain.Entities.Delivery", b =>
                {
                    b.HasOne("SmartCare.Domain.Entities.ApplictionUser", "User")
                        .WithOne("Delivery")
                        .HasForeignKey("SmartCare.Domain.Entities.Delivery", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SmartCare.Domain.Entities.OnlineOrder", b =>
                {
                    b.HasOne("SmartCare.Domain.Entities.Delivery", "Delivery")
                        .WithMany("Orders")
