...
{
    public class GetProductsByCompanyIdHandler : IRequestHandler<GetProductsByCompanyIdQuery, Response<PaginatedResult<ProductResponseDtoForClient>>>
    {
        #region Fields
        ...
        public GetProductsByCompanyIdHandler(IResponseHandler responseHandler, IProductRepository productRepository, IImageUploaderService imageUploaderService, IRedisCacheService redisCacheService, IMapper mapper)
        {
        ...
        public async Task<Response<PaginatedResult<ProductResponseDtoForClient>>> Handle(GetProductsByCompanyIdQuery request, CancellationToken cancellationToken)
        {
