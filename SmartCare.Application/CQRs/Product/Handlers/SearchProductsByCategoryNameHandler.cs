...
{
    public class SearchProductsByCategoryNameHandler : IRequestHandler<SearchProductsByCategoryNameQuery, Response<PaginatedResult<ProductResponseDtoForClient>>>
    {
        #region Fields
        ...
        public SearchProductsByCategoryNameHandler(IResponseHandler responseHandler, IProductRepository productRepository, IImageUploaderService imageUploaderService, IRedisCacheService redisCacheService, IMapper mapper)
        {
        ...
        public async Task<Response<PaginatedResult<ProductResponseDtoForClient>>> Handle(SearchProductsByCategoryNameQuery request, CancellationToken cancellationToken)
        {
