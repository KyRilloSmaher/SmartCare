...
namespace SmartCare.Application.CQRs.Product.Handlers
{
    public class FilterProductsHandler : IRequestHandler<FilterProductsQuery, Response<PaginatedResult<ProductResponseDtoForClient>>>
    {
        ...
        public FilterProductsHandler(IResponseHandler responseHandler, IProductRepository productRepository, IImageUploaderService imageUploaderService, IRedisCacheService redisCacheService, IMapper mapper)
        {
