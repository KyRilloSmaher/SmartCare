...
{
    public class HandlePaymentIntentFailedHandler : IRequestHandler<HandlePaymentIntentFailedAsyncCommand, Response<bool>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ILogger<HandlePaymentIntentFailedHandler> _logger;
        private readonly PaymentExtensions _paymentExtensions;
        private readonly IResponseHandler _responseHandler;
        private readonly IBackgroundJobService _backgroundJobService;

        public HandlePaymentIntentFailedHandler(IUnitOfWork unitOfWork, ILogger<HandlePaymentIntentFailedHandler> logger, PaymentExtensions paymentExtensions, IResponseHandler responseHandler, IBackgroundJobService backgroundJobService)
        {
