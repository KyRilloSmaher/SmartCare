...
{
    public class CreateOrUpdatePaymentHandler : IRequestHandler<RequestpaymentSessionCommandHandler, Response<PaymentSessionResult>>
    {
        ...
        public async Task<Response<PaymentSessionResult>> Handle(RequestpaymentSessionCommandHandler request, CancellationToken cancellationToken)
        {
