...
{
    public class ReSendOTPForResetPasswordCommandHandler : IRequestHandler<ReSendOTPForResetPasswordCommand, Response<bool>>
    {
        #region Fields
        ...
        public ReSendOTPForResetPasswordCommandHandler(
            IResponseHandler responseHandler,
            IUnitOfWork unitOfWork,
            IEmailService emailService,
            ILogger<ReSendOTPForResetPasswordCommandHandler> logger)
        {
