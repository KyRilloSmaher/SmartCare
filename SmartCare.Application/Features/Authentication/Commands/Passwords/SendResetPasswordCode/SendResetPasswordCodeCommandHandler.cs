...
namespace SmartCare.Application.Features.Authentication.Commands.Passwords.SendResetPasswordCode
{
    public class SendResetPasswordCodeCommandHandler : IRequestHandler<SendResetPasswordCodeCommand, Response<bool>>
    {
        #region Fields
